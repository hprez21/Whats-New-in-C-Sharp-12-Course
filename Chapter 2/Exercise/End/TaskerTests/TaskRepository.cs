        ...
        public TaskRepository()
        {
            ...
            Tasks =
                [
                    ...
                    new(3, "Demo Task 3", new TimeSpan(3, 0, 0), CategoryType.Work),
                    new(4, "Demo Task 4", new TimeSpan(4, 0, 0), CategoryType.Hobby),
                    new(5, "Demo Task 5", new TimeSpan(5, 0, 0), CategoryType.Home),
                ];
